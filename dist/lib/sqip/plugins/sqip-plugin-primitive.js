...
const VENDOR_DIR = path_1.default.resolve(__dirname, "..", "..", "..", "..", "primitive-binaries", "bin");
...
class PrimitivePlugin extends types_1.SqipPlugin {
    ...
    async checkForPrimitive() {
        ...
        const primitivePath = path_1.default.join(VENDOR_DIR, `primitive${platform === "win32" ? ".exe" : ""}`);
        console.log(">>>>", primitivePath);
        try {
